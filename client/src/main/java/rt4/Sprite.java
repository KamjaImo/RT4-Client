...
public abstract class Sprite extends SecondaryNode {
	...
	protected abstract void method1416(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int angle, @OriginalArg(5) int arg5);
	...
	public final void renderAngled(@OriginalArg(0) int arg0, @OriginalArg(1) int angle, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		this.method1416(local8, local17, local25, local33, angle, arg2);
	}
