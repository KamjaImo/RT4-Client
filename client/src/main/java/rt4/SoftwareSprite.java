...
public class SoftwareSprite extends Sprite {
	...
	@Override
	protected void method1416(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int angle, @OriginalArg(5) int arg5) {
		if (arg5 == 0) {
			return;
		}
